...
app.controller("workpanelController", function($rootScope, $scope, $q, $uibModal, teamService) {
	$scope.teamUsers = sampleJSON;
	$scope.panel = {usernameToInvite : ""};
	$scope.teams = [];
	$scope.newTeam = {isInviteCollapsed:true, isCreateTeamCollapsed:true};
	...
	$scope.createTeam = function() {
		var tname = $scope.newTeam.teamNameToCreate;
		var tdesc = $scope.newTeam.teamDescriptionToCreate;
		...
		teamService.createTeam({
			...
			$scope.fetchTeams();
			$scope.newTeam.isCreateTeamCollapsed = true;
